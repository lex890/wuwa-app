function Minimize() {
  return(
    <button>
      <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-right-to-bracket" className="svg-inline--fa fa-arrow-right-to-bracket fa-rotate-180" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24">
